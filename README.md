...
# A) Dictionary-Python Program to Sort a Dictionary by Keys and Values
...
# C) File Handling in Python: Count Lines Not Starting with 'T'
...
# E) Classes and Objects in Python: Calculate the Area of a Circle
